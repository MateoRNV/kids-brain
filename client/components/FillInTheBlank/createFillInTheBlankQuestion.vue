<template>
  <div class="create-question">
    ...
    <v-form ref="form2" v-else>
      ...
      <div
        :class="['label', !form2Valid && !explanationText && 'error-border']"
      >
        6. ADD EXPLANATION TEXT*
        <v-text-field class="mt-3" v-model="explanationText"></v-text-field>
